...
import cors from 'cors';  // Insert demo user (password: demo123)
...
db.serialize(() => {
  ...
  const demoPasswordHash = '$2b$10$rGKqGvPa0s0x5W5NQO6w2.XLHNJbTKJ5FfXlj4c1pG8ZfOeE7G.6C';
  db.run(`INSERT OR IGNORE INTO users (email, password_hash, name) VALUES (?, ?, ?)`,
    ['demo@demo.com', demoPasswordHash, 'Demo User']);
